  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        <Link href="/opportunities" className="mb-4 inline-flex items-center gap-1.5 text-sm font-medium text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white">
          <ArrowLeft className="h-4 w-4" /> Opportunities
        </Link>
        <header className="mb-6">
          <h1 className="flex items-center gap-2 text-2xl font-semibold text-slate-950 dark:text-white"><Bookmark className="h-6 w-6" /> Saved opportunities</h1>
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-dashed border-slate-300 dark:border-slate-700 p-10 text-center">
            ...
            <p className="mt-3 text-sm text-slate-500 dark:text-slate-400">You haven&apos;t saved any opportunities yet.</p>
