...
import { createCommunityInviteLink, deleteCommunity, getCommunities, revokeCommunityInviteLink, type CommunitySummary } from '../../../components/guildos/community-list-api';
  ...
  return (
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      <div className="h-36 overflow-hidden bg-gradient-to-r from-indigo-600 to-sky-500">
        {community.coverImage ? <img src={normalizeCommunityImageUrl(community.coverImage)} alt={`${community.name} cover`} className="h-full w-full object-cover" /> : null}
      </div>
